...
public class Sign_up_participant_Activity extends Activity{

	private static final String TAG = Sign_up_participant_Activity.class.getSimpleName();
	...
	void next(){
		Intent intent = new Intent(Sign_up_participant_Activity.this,Login_participant_Activity.class);
