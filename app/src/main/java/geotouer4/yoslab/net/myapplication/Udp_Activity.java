...
//
//            IP_remote = "192.168.0.10"; //IPアドレス
//            port_remote = 1234;       //ポート番号
//
//            // Button1がクリックされたときに呼び出されるコールバックを登録
//            button1.setOnClickListener(new View.OnClickListener() {
//                public void onClick(View v) {
//                    n++;
//                    //文字列を作る
//                    cbuf.append(n);
//                    tv.setText(cbuf.toString());  // tvにはfinalが必要
//                    cbuf.delete(0, 99);
...
//                                ds = new DatagramSocket();  //DatagramSocket作成
//                                byte[] data = message.getBytes();
...
//        }
    ...
    public class Udp_Activity extends Activity{
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            EditText mEditText = (EditText)findViewById(R.id.udp1);
            String udp1 = mEditText.getText().toString();
            System.out.println("udp1=======" + mEditText);
            try{
                soushin(udp1);
            }
            catch(Exception e){
