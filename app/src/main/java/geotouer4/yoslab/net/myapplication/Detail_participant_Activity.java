...
public class Detail_participant_Activity extends FragmentActivity { // (1)
...
//
//        );
//        sp2=PreferenceManager.getDefaultSharedPreferences(
//
//        getBaseContext()
//
//        );
//        sp3=PreferenceManager.getDefaultSharedPreferences(
//
//        getBaseContext()
//
//        );
//        sp4=PreferenceManager.getDefaultSharedPreferences(
//
//        getBaseContext()
//
//        );
//        sp5=PreferenceManager.getDefaultSharedPreferences(
//
//        getBaseContext()
//
//        );
